...
<?php endif; ?>
        ...
        <main>
            <section class="container_banner">
                ...
                <button class="button-comprar" onclick="window.location.href= '/produtos/Produtos.html'">Peça e experimente!</button>
            </section>
            ...
            <section class="produtos">
                ...
                <div class="produtos-grid">
                    <div class="produto">
                        ...
                        <p>R$ 5,00</p>
                        <p class="descricao-produto">Deliciosos cookies recheados com chocolate belga e gotas de caramelo salgado.</p>
                    </div>
                    ...
                    <div class="produto">
                        ...
                        <p>R$ 8,50</p>
                        <p class="descricao-produto">Massa que derrete na boca e delicioso recheio de frango com catupiry.</p>
                    </div>
                    ...
                    <div class="produto">
                        ...
                        <p>R$ 6,00</p>
                        <p class="descricao-produto">Pão de queijo, goiabada cascão e requeijão em barra. O protagonista que tira o fôlego.</p>
                    </div>
  ...
  Assine agora!
            ...
            <section class="comunidade">
                <h2>Comunidade</h2>
                <h3>Nos acompanhe nas redes e participe de nossos eventos comunitários. Junte-se à nossa família Delícias!</h3>
    ...
    <div class="midia tiktok">
      <blockquote class="tiktok-embed"
        ...
        data-video-id="7569310987635952904"
        style="max-width: 100%; min-width: 300px;">
        <section>
          <a target="_blank" href="https://www.tiktok.com/@artesanaldelicias?refer=embed">@artesanaldelicias</a>
